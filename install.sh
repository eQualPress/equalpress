...
then
    ...
    then
        ...
        rm public/.htaccess
        curl -o public/.htaccess https://github.com/eQualPress/equalpress/raw/main/files/public/.htaccess
        "
        ...
        curl -o public/assets/env/config.json http://$USERNAME:$EQ_PORT/envinfo-temp
